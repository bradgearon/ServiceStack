...
//            "System.Xml",
        ...
        {
#if UNITY_STANDALONE
            var outputAssembly = System.IO.Path.GetFullPath(System.IO.Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + "\\Evaluator.dll");
            Debug.Log(outputAssembly);
#endif
